...
<style>
    ...
    .widget { margin-bottom: 30px; margin-top: 100px; background-color: #e9ebef; padding: 50px; border-radius: 6px; }
...
<div class="widget">
    ...
    <div class="summary-block">
        <div class="summary-content">
            <div class="summary-head"><h5 class="summary-title"><?php echo $product['name']; ?></h5></div>
            <div class="summary-price">
                <p class="summary-text">$<?php echo getPrice($product['price']); ?> * <?php echo $product['quantity']; ?> =  $<?php echo getPrice($product['quantity_price']); ?></p>
    ...
    <div class="summary-block">
        <div class="summary-content">
            ...
            <div class="summary-price">
                <p class="summary-text">$<?php echo $total ; ?></p>
            </div>
        </div>
    </div>
    <div class="summary-block">
        <div class="summary-content">
            ...
            <div class="summary-price">
                <p class="summary-text">$<?php echo $userBalance ; ?></p>
            </div>
        </div>
    </div>
</div>
