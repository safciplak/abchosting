...
<div class="widget">
    <?php if ($error == 1) { ?>
        <div class="alert alert-danger">
            <strong>Danger!</strong> There is not enough cash
        </div>
    <?php } ?>
        ...
        <div class="summary-block">
            <div class="summary-content">
                ...
                <div class="summary-price">
                    <p class="summary-text">$<?php echo getPrice($product['price']); ?>
                        * <?php echo $product['quantity']; ?> = $<?php echo getPrice($product['quantity_price']); ?></p>
